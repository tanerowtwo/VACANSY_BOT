...
exclude_words = [
    ...
    "нахожусь в поисках проектов", "я монтажёр", "я монтажер", "я видеомонтажер",
    "#портфолио", "#помогу", "#рилсмейкер", "предлагаю свою кандидатуру",
    "делаю монтаж", "мое портфолио", "я #видеомонтажёр", "работаю с блогерами",
    "reels / shorts / tiktok", "добро пожаловать в группу шапка чат.", "я занимаюсь монтажом",
    "создам красивую картинку", "я монтирую", "занимаюсь монтажом", "я помогу тебе",
    "мой монтаж", "предлагаю услуги", "почему вам стоит выбрать меня", "ищу новые проекты",
    "я оператор-постановщик", "почему стоит выбрать меня", "reels", "я - монтажер",
    "я начинающий монтажёр", "я начинающий специалист", "я видеооператор-монтажер",
    "я колорист", "я занимаюсь монтажем", "создаю ролики"
]
